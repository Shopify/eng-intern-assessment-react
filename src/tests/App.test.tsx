...
describe('Stopwatch functionality', () => {
  test('The buttons of starts, stops, resets, and records laps should be correct', () => {
    ...
    act(() => {
        setTimeout(() => { // ** using setTimeout here to ensure that the app has time to actually find the lap time elements
          // Find the lap time elements using queryAllByRole
          const lapTimeElements = screen.queryAllByRole('listitem', { name: /00:00:02\.000/ });
